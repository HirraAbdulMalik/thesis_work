...
def score_triplets(params):
    ...
    print('1 ->', os.path.join('../data/{}/{}_{}_predictions.txt'.format(params.dataset, params.ensemble_model_1, params.file_to_score)))
    print('2 ->', os.path.join('../data/{}/{}_{}_predictions.txt'.format(params.dataset, params.ensemble_model_2, params.file_to_score)))
    ...
    print(len(ens_model_1_triplets))
    print(len(ens_model_2_triplets))
